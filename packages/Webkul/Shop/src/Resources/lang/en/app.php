...
return [
    'customers' => [
        ...
        'reset-password' => [
            ...
            'footer'           => '© Copyright :current_year, Raden Catering. All rights reserved.',
            'password'         => 'Password',
        ...
        'login-form' => [
            'button-title'        => 'Masuk',
            'bagisto'             => 'Bagisto',
            'create-your-account' => 'Daftar',
            'email'               => 'Email',
            'form-login-text'     => 'Masuk menggunakan e-mail.',
            'footer'              => '© Copyright :current_year, Raden Catering. All rights reserved.',
            'forgot-pass'         => 'Lupa Passoword?',
        ...
        'signup-form' => [
            ...
            'bagisto'                     => 'Bagisto',
            'button-title'                => 'Daftar',
            'confirm-pass'                => 'Ulangi Password',
            'email'                       => 'Email',
            'first-name'                  => 'First Name',
            'footer'                      => '© Copyright :current_year, Raden Catering. All rights reserved.',
            'form-signup-text'            => 'Silakan isi form di bawah ini.',
            'last-name'                   => 'Last Name',
            'page-title'                  => 'Buat Akun',
            'password'                    => 'Password',
            'sign-in-button'              => 'Masuk',
            'subscribe-to-newsletter'     => 'Info harian tentang Raden Catering',
    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                ...
                'compare'       => 'Compare',
                'cart'          => 'Cart',
                'dropdown-text' => 'Kelola Keranjang & Pesanan',
                'logout'        => 'Logout',
                'orders'        => 'Orders',
                'profile'       => 'Profile',
                'sign-in'       => 'Masuk',
                'sign-up'       => 'Daftar',
                'search-text'   => 'Cari menu favoritmu',
                'search'        => 'Search',
                'title'         => 'Account',
                'welcome'       => 'Welcome',
            ...
            'footer' => [
                ...
                'currency'               => 'Currency',
                'email'                  => 'Email',
                'footer-text'            => '© Copyright 2024, Raden Catering. All rights reserved.',
                'locale'                 => 'Locale',
                'newsletter-text'        => 'Berlangganan info tentang Raden Catering!',
                'order-return'           => 'Order and Returns',
                'payment-policy'         => 'Payment Policy',
                'privacy-cookies-policy' => 'Privacy and Cookies Policy',
                'subscribe-stay-touch'   => 'Berlangganan untuk info terupdate.',
    ...
    'products' => [
        ...
        'sort-by' => [
            'title'   => 'Sort By',
            'options' => [
                'cheapest-first'  => 'Harga Terendah',
                'expensive-first' => 'Harga Tertinggi',
                'from-a-z'        => 'Dari A-Z',
                'from-z-a'        => 'Dari Z-A',
    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'item-add-to-cart'          => 'Menu Berhasil Ditambahkan',
            ...
            'mini-cart' => [
                ...
                'offer-on-orders'      => 'Silakan tambah menu pesanan.',
                'remove'               => 'Hapus',
        ...
        'onepage' => [
            'addresses' => [
                'billing' => [
                    ...
                    'billing-address'      => 'Daftar Alamat',
                    'back'                 => 'Back',
                    'company-name'         => 'Company Name',
                    'country'              => 'Country',
                    'city'                 => 'City',
                    'confirm'              => 'Pilih Alamat',
                    'email'                => 'Email',
                    'first-name'           => 'First Name',
                    'last-name'            => 'Last Name',
                    'postcode'             => 'Zip/Postcode',
                    'same-billing-address' => 'Alamat sama dengan "Alamat Pengiriman"',
                    'street-address'       => 'Street Address',
                    'state'                => 'State',
