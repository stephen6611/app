...
<footer class="mt-[36px] bg-lightOrange  max-sm:mt-[30px]">
    <div class="flex gap-x-[25px] gap-y-[30px] justify-center p-[60px] max-1060:flex-wrap max-1060:flex-col-reverse max-sm:px-[15px]">
    ...
    <div class="flex justify-center px-[60px] py-[13px] bg-[#F1EADF]">
